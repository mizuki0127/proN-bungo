...
if(navigator.geolocation.getCurrentPosition)
{
    ...
    function( position )
    {
        ...
        //6番目に近い
        if(answer[5] === calcuA) {
            answer6 = '<a href="inokasira.html"><img src="井の頭公園.png" alt="井の頭公園"></a>';
            document.getElementById('result-area6').innerHTML = answer6;
        }else if (answer[5] === calcuB) {
            answer6 = '<a href="isentei.html"><img src="isentei.png" alt="isentei"></a>';
            document.getElementById('result-area6').innerHTML = answer6;
        }else if (answer[5] === calcuC) {
            answer6 = '<a href="syayoukan.html"><img src="斜陽館.png" alt="斜陽館"></a>';
            document.getElementById('result-area6').innerHTML = answer6;
        }else if (answer[5] === calcuD) {
            answer6 = '<a href="yasuda.html"><img src="安田屋.png" alt="安田屋旅館"></a>';
            document.getElementById('result-area6').innerHTML = answer6;
        }else if (answer[5] === calcuE) {
            answer6 = '<a href="dazaisokai.html"><img src="太宰疎開.png" alt="太宰治疎開の家"></a>';
            document.getElementById('result-area6').innerHTML = answer6;
        }else if (answer[5] === calcuF) {
            answer6 = '<a href="ekisya.html"><img src="駅舎.png" alt="喫茶店「駅舎」"></a>';
            document.getElementById('result-area6').innerHTML = answer6;
        }else if (answer[5] === calcuG) {
            answer6 = '<a href="asino.html"><img src="芦野公園.png" alt="芦野公園"></a>';
            document.getElementById('result-area6').innerHTML = answer6;
        }else if (answer[5] === calcuH) {
            answer6 = '<a href="hukaura.html"><img src="ふかうら文学館.png" alt="ふかうら文学館"></a>';
            document.getElementById('result-area6').innerHTML = answer6;
        }else if (answer[5] === calcuI) {
            answer6 = '<a href="rupan.html"><img src="ルパン.png" alt="銀座ルパン"></a>';
            document.getElementById('result-area6').innerHTML = answer6;
        }else if (answer[5] === calcuJ) {
            answer6 = '<a href="arai.html"><img src="新井旅館.png" alt="新井旅館"></a>';
            document.getElementById('result-area6').innerHTML = answer6;
        }
        ...
        if(answer[6] === calcuA) {
            answer6 = '<a href="inokasira.html"><img src="井の頭公園.png" alt="井の頭公園"></a>';
            document.getElementById('result-area7').innerHTML = answer6;
        }else if (answer[6] === calcuB) {
            answer6 = '<a href="isentei.html"><img src="isentei.png" alt="isentei"></a>';
            document.getElementById('result-area7').innerHTML = answer6;
        }else if (answer[6] === calcuC) {
            answer6 = '<a href="syayoukan.html"><img src="斜陽館.png" alt="斜陽館"></a>';
            document.getElementById('result-area7').innerHTML = answer6;
        }else if (answer[6] === calcuD) {
            answer6 = '<a href="yasuda.html"><img src="安田屋.png" alt="安田屋旅館"></a>';
            document.getElementById('result-area7').innerHTML = answer6;
        }else if (answer[6] === calcuE) {
            answer6 = '<a href="dazaisokai.html"><img src="太宰疎開.png" alt="太宰治疎開の家"></a>';
            document.getElementById('result-area7').innerHTML = answer6;
        }else if (answer[6] === calcuF) {
            answer6 = '<a href="ekisya.html"><img src="駅舎.png" alt="喫茶店「駅舎」"></a>';
            document.getElementById('result-area7').innerHTML = answer6;
        }else if (answer[6] === calcuG) {
            answer6 = '<a href="asino.html"><img src="芦野公園.png" alt="芦野公園"></a>';
            document.getElementById('result-area7').innerHTML = answer6;
        }else if (answer[6] === calcuH) {
            answer6 = '<a href="hukaura.html"><img src="ふかうら文学館.png" alt="ふかうら文学館"></a>';
            document.getElementById('result-area7').innerHTML = answer6;
        }else if (answer[6] === calcuI) {
            answer6 = '<a href="rupan.html"><img src="ルパン.png" alt="銀座ルパン"></a>';
            document.getElementById('result-area7').innerHTML = answer6;
        }else if (answer[6] === calcuJ) {
            answer6 = '<a href="arai.html"><img src="新井旅館.png" alt="新井旅館"></a>';
            document.getElementById('result-area7').innerHTML = answer6;
        }
        ...
        if(answer[7] === calcuA) {
            answer6 = '<a href="inokasira.html"><img src="井の頭公園.png" alt="井の頭公園"></a>';
            document.getElementById('result-area8').innerHTML = answer6;
        }else if (answer[7] === calcuB) {
            answer6 = '<a href="isentei.html"><img src="isentei.png" alt="isentei"></a>';
            document.getElementById('result-area8').innerHTML = answer6;
        }else if (answer[7] === calcuC) {
            answer6 = '<a href="syayoukan.html"><img src="斜陽館.png" alt="斜陽館"></a>';
            document.getElementById('result-area8').innerHTML = answer6;
        }else if (answer[7] === calcuD) {
            answer6 = '<a href="yasuda.html"><img src="安田屋.png" alt="安田屋旅館"></a>';
            document.getElementById('result-area8').innerHTML = answer6;
        }else if (answer[7] === calcuE) {
            answer6 = '<a href="dazaisokai.html"><img src="太宰疎開.png" alt="太宰治疎開の家"></a>';
            document.getElementById('result-area8').innerHTML = answer6;
        }else if (answer[7] === calcuF) {
            answer6 = '<a href="ekisya.html"><img src="駅舎.png" alt="喫茶店「駅舎」"></a>';
            document.getElementById('result-area8').innerHTML = answer6;
        }else if (answer[7] === calcuG) {
            answer6 = '<a href="asino.html"><img src="芦野公園.png" alt="芦野公園"></a>';
            document.getElementById('result-area8').innerHTML = answer6;
        }else if (answer[7] === calcuH) {
            answer6 = '<a href="hukaura.html"><img src="ふかうら文学館.png" alt="ふかうら文学館"></a>';
            document.getElementById('result-area8').innerHTML = answer6;
        }else if (answer[7] === calcuI) {
            answer6 = '<a href="rupan.html"><img src="ルパン.png" alt="銀座ルパン"></a>';
            document.getElementById('result-area8').innerHTML = answer6;
        }else if (answer[7] === calcuJ) {
            answer6 = '<a href="arai.html"><img src="新井旅館.png" alt="新井旅館"></a>';
            document.getElementById('result-area8').innerHTML = answer6;
        }
